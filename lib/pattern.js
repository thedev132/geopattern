...
Pattern.prototype.geoConcentricCircles = function () {
    ...
    this.svg.setWidth((ringSize + strokeWidth) * 6 * 1.2); 
    ...
    for (y = 0; y < 6; y++) {
        for (x = 0; x < 6; x++) {
            ...
            this.svg.circle(
                x * ringSize * 1.1 + x * strokeWidth * 1.1 + (ringSize + strokeWidth) / 2, 
...
Pattern.prototype.geoTessellation = function () {
    ...
    var scale          = scalePattern(hexVal(this.hash, 0), this.opts.scalePattern);
    var sideLength     = map(scale, 0, 13, 12, 40); 
    var hexHeight      = sideLength * Math.sqrt(3);
    var hexWidth       = sideLength * 2;
    var triangleHeight = sideLength / 2 * Math.sqrt(3);
    ...
    this.svg.setWidth(tileWidth * 3);  
    this.svg.setHeight(tileHeight * 1.5); 

    for (var row = 0; row < 5; row++) {
        for (var col = 0; col < 5; col++) {
            var xOffset = col * tileWidth;
            var yOffset = row * tileHeight * 2;
            ...
            for (i = 0; i < 20; i++) {
                ...
                switch (i) {
                    case 0: // All 4 corners
                        this.svg.rect(-sideLength / 2 + xOffset, -sideLength / 2 + yOffset, sideLength, sideLength, styles);
                        this.svg.rect(tileWidth - sideLength / 2 + xOffset, -sideLength / 2 + yOffset, sideLength, sideLength, styles);
                        this.svg.rect(-sideLength / 2 + xOffset, tileHeight - sideLength / 2 + yOffset, sideLength, sideLength, styles);
                        this.svg.rect(tileWidth - sideLength / 2 + xOffset, tileHeight - sideLength / 2 + yOffset, sideLength, sideLength, styles);
                        break;
                    case 1: // Center / top square
                        this.svg.rect(hexWidth / 2 + triangleHeight + xOffset, hexHeight / 2 + yOffset, sideLength, sideLength, styles);
                        break;
                    case 2: // Side squares
                        this.svg.rect(-sideLength / 2 + xOffset, tileHeight / 2 - sideLength / 2 + yOffset, sideLength, sideLength, styles);
                        this.svg.rect(tileWidth - sideLength / 2 + xOffset, tileHeight / 2 - sideLength / 2 + yOffset, sideLength, sideLength, styles);
                        break;
                    case 3: // Center / bottom square
                        this.svg.rect(hexWidth / 2 + triangleHeight + xOffset, hexHeight * 1.5 + sideLength + yOffset, sideLength, sideLength, styles);
                        break;
                    case 4: // Left top / bottom triangle
                        this.svg.polyline(triangle, styles).transform({
                            translate: [sideLength / 2 + xOffset, -sideLength / 2 + yOffset],
                            rotate: [0, sideLength / 2, triangleHeight / 2]
                        });
                        this.svg.polyline(triangle, styles).transform({
                            translate: [sideLength / 2 + xOffset, tileHeight - -sideLength / 2 + yOffset],
                            rotate: [0, sideLength / 2, triangleHeight / 2],
                            scale: [1, -1]
                        });
                        break;
					...
					this.svg.polyline(triangle, styles).transform({
						translate: [
							tileWidth - sideLength / 2 + xOffset,
							-sideLength / 2 + yOffset
						],
						rotate: [
							0,
							sideLength / 2,
					...
					this.svg.polyline(triangle, styles).transform({
						translate: [
							tileWidth - sideLength / 2 + xOffset,
							tileHeight + sideLength / 2 + yOffset
						],
						rotate: [
							0,
							sideLength / 2,
				...
				case 6: // Center / top / right triangle
					this.svg.polyline(triangle, styles).transform({
						translate: [
							tileWidth / 2 + sideLength / 2 + xOffset,
							hexHeight / 2 + yOffset
						]
					});
					break;
				case 7: // Center / top / left triangle
					this.svg.polyline(triangle, styles).transform({
						translate: [
							tileWidth - tileWidth / 2 - sideLength / 2 + xOffset,
							hexHeight / 2 + yOffset
						],
						scale: [-1, 1]
					});
				...
				case 8: // Center / bottom / right triangle
					this.svg.polyline(triangle, styles).transform({
						translate: [
							tileWidth / 2 + sideLength / 2 + xOffset,
							tileHeight - hexHeight / 2 + yOffset
						],
						scale: [1, -1]
					});
					break;
				...
				case 10: // Left / middle triangle
					this.svg.polyline(triangle, styles).transform({
						translate: [
							sideLength / 2 + xOffset,
							tileHeight / 2 - sideLength / 2 + yOffset
						]
					});
					break;
				...
				case 13: // Right / top square
					this.svg.rect(0, 0, sideLength, sideLength, styles).transform({
						scale: [-1, 1],
						translate: [-tileWidth + sideLength / 2 + xOffset, sideLength / 2 + yOffset],
						rotate: [-30, 0, 0]
					});
					break;
				case 14: // Left / center-top square
					this.svg.rect(0, 0, sideLength, sideLength, styles).transform({
						translate: [
							sideLength / 2 + xOffset,
							tileHeight / 2 - sideLength / 2 - sideLength + yOffset
						],
				...
				case 16: // Left / center-top square
					this.svg.rect(0, 0, sideLength, sideLength, styles).transform({
						...
						translate: [
							sideLength / 2 + xOffset,
							-tileHeight + tileHeight / 2 - sideLength / 2 - sideLength + yOffset
						],
						rotate: [30, 0, sideLength]
					});
					break;
